...
import { RUTAS, DOMINIOS, todosLosModulos } from '../catalogo';

export default function Landing() {
  const totalModulos = todosLosModulos().length;
  const totalPreguntas = todosLosModulos().reduce((s, m) => s + m.preguntas.length, 0);
    ...
    <div className="max-w-6xl mx-auto px-4">
      ...
      <section className="pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8">
          ...
          análisis de malware. Gana XP, insignias y avanza por los 5 dominios de la seguridad.
        </p>
