// Contenido del curso — copia versionada del catálogo.
//
// En ejecución el contenido vive en SQLite y se edita desde /admin;
// este archivo es la SEMILLA (se carga en una base vacía) y sirve como
